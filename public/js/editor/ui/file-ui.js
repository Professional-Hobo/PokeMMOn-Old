$(function() {
  ...
  $("#deleteWorldYes").click(function() {
    $.ajax("editor/world/" + worldName, {type: 'DELETE', global: false, success: function(result) {
  ...
  $('#newWorldSave').click(function() {
    ...
    $.ajax("editor/world", {method: "POST", contentType : 'application/json', data: JSON.stringify({name: name, data: pokeworld.export()}), global: false, success: function(data) {
  ...
  function loadWorld(suppress) {
    $.ajax("editor/world/" + worldName, {global: true, suppress: true, success: function(data) {
